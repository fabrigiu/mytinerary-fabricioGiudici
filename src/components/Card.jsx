...
function CityCard({ name, country, image, id }) {
  return (
    <div className="city-card group relative block m-4 h-64 w-[90%] transition-all md:w-1/3 md:hover:w-1/3 lg:w-1/5 lg:hover:w-1/5 sm:h-80 lg:h-96">
      ...
      >
        ...
        <div className="absolute text-black p-4 h-full hidden opacity-0 overflow-hidden transition-opacity duration-0 group-hover:flex group-hover:flex-col group-hover:relative group-hover:opacity-100 sm:p-6 lg:p-4">
          <h3 className="bg-orange-300  text-slate-100 mt-2 px-1 rounded text-base mx-auto w-fit font-bold md:mt:1 sm:text-xl">
            {name},
          </h3>
          <h3 className="bg-orange-300  text-slate-100 px-1 rounded text-base mx-auto w-fit font-bold md:mt:1 sm:text-xl">
            {country}
          </h3>
